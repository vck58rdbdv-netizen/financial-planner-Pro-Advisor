...
window.systemDictionary = {
    ...
    "manual-3": {
        ...
        content: `
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm animate-fade-in">
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-emerald-50 p-4 rounded-xl border border-emerald-200 shadow-sm hover-scale">
                                <b class="text-emerald-800 flex items-center gap-2 mb-2"><span class="text-lg">📖</span> คู่มือ / แนะนำระบบ</b>
                            ...
                            <div class="bg-blue-50 p-4 rounded-xl border border-blue-200 shadow-sm hover-scale">
                                <b class="text-blue-800 flex items-center gap-2 mb-2"><span class="text-lg">📝</span> ระบบประเมินการเงิน</b>
                            ...
                            <div class="bg-purple-50 p-4 rounded-xl border border-purple-200 shadow-sm hover-scale">
                                <b class="text-purple-800 flex items-center gap-2 mb-2"><span class="text-lg">⚙️</span> ตั้งค่าระบบ</b>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-4">
                                <div class="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100 hover-scale">
                            ...
                            <div class="bg-white p-4 rounded-xl border border-indigo-200 shadow-lg relative">
                                <div class="absolute -right-3 -top-3 text-5xl opacity-10">📝</div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-purple-50 p-4 rounded-xl border border-purple-100 hover-scale">
                            ...
                            <div class="bg-sky-50 p-4 rounded-xl border border-sky-100 hover-scale">
                            ...
                            <div class="bg-teal-50 p-4 rounded-xl border border-teal-100 hover-scale">
                            ...
                            <div class="bg-red-50 p-4 rounded-xl border border-red-100 hover-scale">
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="flex items-start gap-4 p-3 bg-gray-50 rounded-xl border border-gray-200">
                                <div class="bg-white border border-gray-200 p-2 rounded shadow-sm text-2xl leading-none flex items-center justify-center">📂</div>
                                <div>
                            ...
                            <div class="flex items-start gap-4 p-3 bg-red-50 rounded-xl border border-red-200 shadow-sm">
                                <div class="bg-white border border-red-200 p-2 rounded shadow-sm text-2xl leading-none flex items-center justify-center animate-pulse-soft">⚙️</div>
                                <div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-red-700 to-gray-900 p-4 border-b border-red-600 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">7</div> 
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="border border-gray-200 rounded-xl p-4 bg-gray-50 text-center flex flex-col items-center hover-scale">
                        ...
                        <div class="bg-gray-800 text-white p-4 rounded-xl flex items-center shadow-lg mt-5 border border-gray-700">
                            <div>
                                <b class="text-cyan-400 text-sm block mb-2 flex items-center gap-2"><span>💻</span> วิธีตั้งค่าเบราว์เซอร์ให้บันทึก PDF สวยงามที่สุด</b>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-4 border-b border-blue-500 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">8</div> 
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-5">
                        ...
                        <div class="space-y-4">
                            <div class="bg-blue-50 p-4 rounded-xl border border-blue-100">
                                ...
                                <p class="text-xs text-gray-700 mb-2">เมื่อคุณกรอกข้อมูลในหน้าหลักและกดประมวลผล (คำนวณ AI) เรียบร้อยแล้ว ให้เข้าไปที่เมนู <b>"⚙️ ตั้งค่าระบบ > 🗂️ ฐานข้อมูลลูกค้า"</b> แล้วกดปุ่ม <span class="bg-blue-600 text-white px-2 py-1 rounded text-[10px] font-bold flex-inline items-center gap-1"><span>💾</span> ดึงข้อมูลหน้าจอหลักบันทึกลง DB</span></p>
                            ...
                            <div class="bg-blue-50 p-4 rounded-xl border border-blue-100">
                                ...
                                <ul class="list-disc list-inside text-xs text-gray-700 ml-2 space-y-2">
                                    <li><b>มุมมองกระดาน (Kanban) <span class="bg-white px-1 rounded shadow-sm text-[10px]">📌</span>:</b> เป็นมุมมองแบบ ไปป์ไลน์งานขาย (Sales Pipeline) <b>คลิกค้างที่การ์ดลูกค้าแล้วลาก (Drag & Drop) ข้ามสเตจสถานะได้เลย</b> ระบบจะเปลี่ยนสถานะและจด Log ประวัติการทำงานให้อัตโนมัติ</li>
                                    <li><b>มุมมองตาราง (Table) <span class="bg-white px-1 rounded shadow-sm text-[10px]">📋</span>:</b> เหมาะสำหรับการจัดการคนจำนวนมาก รองรับการกดหัวคอลัมน์เพื่อเรียงลำดับ (Sort) และการเลือก Checkbox หน้าชื่อ เพื่อใช้งานแถบเครื่องมือด้านบน <b>(พิมพ์รายงานกลุ่ม / ลบหลายคน / เปลี่ยนสถานะพร้อมกันหลายคน)</b></li>
                                </ul>
                            </div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-amber-500 to-orange-600 p-4 border-b border-orange-500 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">9</div> 
                        <h3 class="font-bold text-white text-lg">การใช้ FA Business Planner (Dashboard ผู้บริหาร)</h3>
                    </div>
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        <p class="leading-relaxed">นอกจากใช้ดูแลลูกค้าแล้ว ระบบยังมี Dashboard ส่วนตัวสำหรับให้ตัวคุณเอง (FA) ตั้งเป้าหมายและติดตาม Performance การขายตลอดทั้งปี สามารถเปิดได้โดยการคลิกแท็บ <span class="text-emerald-700 font-bold bg-emerald-50 px-2 py-1 rounded-lg border border-emerald-200 shadow-sm flex-inline items-center gap-1"><span>📊</span> FA Business Planner</span></p>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="bg-orange-50 p-5 rounded-xl border border-orange-100 hover-scale">
                                <b class="text-orange-800 flex items-center gap-2 mb-3"><span class="text-lg">🎯</span> การตั้งเป้าหมาย (Yearly Targets)</b>
                            ...
                            <div class="bg-orange-50 p-5 rounded-xl border border-orange-100 hover-scale flex flex-col">
                                <b class="text-orange-800 flex items-center gap-2 mb-3"><span class="text-lg">📝</span> บันทึกผลงาน (Sales Ledger)</b>
                        ...
                        <div class="bg-gray-50 p-5 rounded-xl border border-gray-200 mt-5 shadow-inner">
                            <b class="text-gray-800 flex items-center gap-2 mb-3"><span class="text-lg">📈</span> การวิเคราะห์พอร์ตโฟลิโอ (Portfolio Analytics)</b>
                            ...
                            <div class="flex flex-col md:flex-row gap-5 mt-2">
                                <div class="flex-1 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                                    <b class="text-[12px] text-indigo-800 flex items-center gap-1 border-b border-gray-100 pb-1.5 mb-2"><span class="text-base">🧬</span> AI Personas (กลุ่มลูกค้า)</b>
                                ...
                                <div class="flex-1 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                                    <b class="text-[12px] text-blue-800 flex items-center gap-1 border-b border-gray-100 pb-1.5 mb-2"><span class="text-base">🥧</span> Product Mix (สัดส่วนสินค้า)</b>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-slate-700 to-slate-900 p-4 border-b border-slate-600 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">10</div> 
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        <div class="bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg shadow-sm mb-4">
                            <p class="text-xs text-red-800 font-bold flex items-center gap-2 mb-1"><span class="text-lg">⚠️</span> โปรดอ่านให้เข้าใจก่อนใช้งานระบบ!</p>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm hover-scale">
                            ...
                            <div class="flex items-start gap-4 p-4 bg-emerald-50 rounded-xl border border-emerald-200 shadow-sm hover-scale relative overflow-hidden">
                                <div class="absolute -right-2 -bottom-2 text-6xl opacity-10">📥</div>
                                <div class="text-3xl mt-1 relative z-10">📥</div>
                            ...
                            <div class="flex items-start gap-4 p-4 bg-blue-50 rounded-xl border border-blue-200 shadow-sm hover-scale">
                                <div class="text-3xl mt-1">🩺</div>
                                <div>
                            ...
                            <div class="flex items-start gap-4 p-4 bg-red-50 rounded-xl border border-red-200 shadow-sm hover-scale">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-amber-500 to-orange-500 p-4 border-b border-orange-600 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">11</div> 
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center gap-4 bg-white p-3.5 rounded-xl border border-orange-100 shadow-sm hover-scale">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-fuchsia-600 to-pink-600 p-4 border-b border-fuchsia-700 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">12</div> 
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-pink-50 p-4 rounded-xl border border-pink-100 hover-scale">
                            ...
                            <div class="bg-indigo-50 p-4 rounded-xl border border-indigo-100 hover-scale">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-sky-600 to-blue-700 p-4 border-b border-sky-700 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">13</div> 
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="bg-sky-50 p-4 rounded-xl border border-sky-200 relative shadow-inner">
                            <b class="text-sky-800 text-sm block mb-3 flex items-center gap-2"><span>🔄</span> Workflow สำหรับการส่งต่องานระหว่างผู้ช่วยและ FA</b>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r from-emerald-600 to-teal-700 p-4 border-b border-emerald-600 flex items-center gap-3">
                        <div class="bg-white/20 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold shadow-inner">14</div> 
                    ...
                    <div class="p-5 text-sm text-gray-700 space-y-4">
                        ...
                        <div class="bg-emerald-50 p-5 rounded-xl border border-emerald-200 shadow-sm relative overflow-hidden">
                            <div class="absolute -right-2 -top-2 text-6xl opacity-10">💬</div>
    ...
    "math-kmeans": {
        ...
        <div class="space-y-5">
            ...
            <div class="bg-indigo-50 p-4 rounded-xl border border-indigo-100 shadow-sm">
                <b class="text-indigo-800 mb-2 block">📊 8 มิติพฤติกรรมที่ AI ใช้จับอัตลักษณ์ (8D Features)</b>
            ...
            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                <b class="text-purple-800 mb-2">📐 สมการหาระยะห่าง (Euclidean Distance in 8D Space)</b>
                ...
                <div class="mb-2 bg-purple-50 p-3 rounded-lg font-mono text-[11px] border border-purple-100 text-center text-purple-900 shadow-inner">
            ...
            <div class="bg-white p-4 rounded-xl border shadow-sm">
                <b class="text-blue-800 mb-3 block flex items-center gap-2"><span class="text-lg">🔍</span> Case Study: AI จัดกลุ่มอย่างไร?</b>
            ...
            <div class="bg-slate-800 p-5 rounded-xl shadow-md text-white border border-slate-700 relative overflow-hidden">
                ...
                <b class="text-yellow-400 mb-2 block relative z-10">⚠️ ระบบตรวจจับความผิดปกติ (Anomaly Threshold)</b>
    ...
    "math-consensus": {
        ...
        <div class="space-y-4">
            ...
            <div class="bg-blue-50 p-4 rounded-xl border border-blue-200 shadow-sm flex flex-col">
                <b class="text-blue-800 mb-2 flex items-center gap-2">Step 1: แบ่งกลุ่มพฤติกรรมภาพรวม (Macro Segmentation ด้วย 8D K-Means)</b>
            ...
            <div class="bg-yellow-50 p-4 rounded-xl border border-yellow-200 shadow-sm flex flex-col">
                <b class="text-yellow-800 mb-2">Step 3: ตรวจจับพฤติกรรมเสี่ยง & หักลดทอนคะแนน (Dynamic Discounting)</b>
                ...
                <ul class="text-[11px] list-none p-3 font-mono bg-white border border-yellow-100 rounded-lg text-yellow-900 space-y-1.5 mb-2">
                    <li>if(พบ "พึ่งพาสินเชื่อ") &Sigma;D<sub>rate</sub> += 0.20 <i>(หัก 20%)</i></li>
                    <li>if(พบ "หมุนเงินชนเดือน") &Sigma;D<sub>rate</sub> += 0.15 <i>(หัก 15%)</i></li>
                    <li>if(พบ "ละเลยความคุ้มครอง") &Sigma;D<sub>rate</sub> += 0.10 <i>(หัก 10%)</i></li>
            ...
            <div class="bg-red-50 p-4 rounded-xl border border-red-200 shadow-sm flex flex-col">
                <b class="text-red-800 mb-2">Step 4: ตรวจจับวิกฤตและล็อกเพดานคะแนน (Critical Hard Caps)</b>
                ...
                <ul class="text-[11px] list-none p-3 font-mono bg-white border border-red-100 rounded-lg text-red-900 space-y-1 mb-1">
                    <li>if(พบ "หนี้สินอันตราย/ล้นพ้นตัว") &rarr; Cap<sub>hard</sub> = 45.0% <i>(แผนมีความเสี่ยงพังทลายสูงมาก)</i></li>
                    <li>else (ไม่พบความเสี่ยงระดับวิกฤต) &rarr; Cap<sub>hard</sub> = 100.0% <i>(ปล่อยให้เป็นไปตามการลดทอนใน Step 3)</i></li>
                </ul>
            </div>

            <!-- ขั้นตอนที่ 5: End-to-End Execution -->
            <div class="bg-slate-800 p-4 rounded-xl shadow-sm flex flex-col text-white">
                <b class="text-cyan-400 mb-2">Step 5: สมการรวบยอด & ตัวอย่างการประมวลผลจริง (Execution Engine)</b>
                <div class="bg-slate-900 p-3 rounded-lg font-mono text-[11px] border border-slate-700 text-cyan-100 mb-4 space-y-1 overflow-x-auto shadow-inner">
                    <p><b>1. ตัดส่วนลด:</b> P<sub>discounted</sub> = P<sub>ML</sub> &times; (1 - &Sigma;D<sub>rate</sub>)</p>
                    <p><b>2. บังคับเพดาน:</b> P<sub>final</sub> = max(0.1, min(99.9, min(P<sub>discounted</sub>, Cap<sub>hard</sub>)))</p>
                </div>
    ...
    "math-market": {
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                <b class="text-red-800 mb-2 flex items-center gap-2"><span class="text-lg">📚</span> 1. ทฤษฎี: Merton's Jump Diffusion Model</b>
                ...
                <div class="bg-red-50 p-4 rounded-lg font-mono text-[11px] border border-red-100 text-red-900 mb-2 overflow-x-auto shadow-inner">
                    <p class="text-center font-bold text-[13px] mb-3">R<sub>yearly</sub> = exp[ (&mu; - &sigma;<sup>2</sup>/2)&Delta;t + &sigma;&radic;&Delta;t Z + J(&pi;) ] - 1</p>
            ...
            <div class="bg-blue-50 p-5 rounded-xl border border-blue-200 shadow-sm flex flex-col">
                <b class="text-blue-800 mb-2 flex items-center gap-2"><span class="text-lg">⚙️</span> 2. ปัจจัยนำเข้าแบบจำลอง (Simulation Inputs)</b>
            ...
            <div class="bg-slate-800 p-5 rounded-xl shadow-md text-white border border-slate-700 relative overflow-hidden">
                <div class="absolute -right-4 -bottom-4 text-7xl opacity-10">💡</div>
                <b class="text-cyan-400 mb-3 block relative z-10 flex items-center gap-2"><span class="text-lg">📊</span> 3. การแปลผลลัพธ์ (Output Interpretation)</b>
            ...
            <div class="bg-emerald-50 p-5 rounded-xl border border-emerald-200 shadow-sm flex flex-col">
                <b class="text-emerald-800 mb-3 flex items-center gap-2"><span class="text-lg">🛠️</span> 4. ภาคปฏิบัติ: การประยุกต์ใช้เพื่อวางแผนหน้างาน (Practical FA Action)</b>
                ...
                <div class="space-y-3">
                    <!-- สถานการณ์ที่ 1 -->
                    <div class="bg-white p-3.5 rounded-lg border border-emerald-100 shadow-sm hover:shadow-md transition">
    ...
    "math-accum": {
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                <b class="text-blue-800 mb-2 flex items-center gap-2"><span class="text-lg">🛤️</span> 1. โมเดลปรับลดความเสี่ยงอัตโนมัติ (Dynamic Glide Path Model)</b>
                ...
                <div class="bg-blue-50 p-4 rounded-lg font-mono text-[11px] border border-blue-100 text-blue-900 space-y-2 mb-3 shadow-inner">
                    <p class="font-bold border-b border-blue-200 pb-1 mb-2 text-[12px]">Linear Interpolation Equation:</p>
                    <p class="text-center text-[13px] font-bold">&sigma;<sub>t</sub> = &sigma;<sub>start</sub> - [ (&sigma;<sub>start</sub> - &sigma;<sub>target</sub>) &times; (t / T) ]</p>
                </div>
            ...
            <div class="bg-indigo-50 p-5 rounded-xl border border-indigo-200 shadow-sm flex flex-col">
                <b class="text-indigo-800 mb-2 flex items-center gap-2"><span class="text-lg">🎲</span> 2. สมการทบต้นความมั่งคั่งเชิงสถิติ (Stochastic Wealth Accumulation)</b>
                ...
                <div class="mt-2 mb-3 bg-white p-4 rounded-lg font-mono text-[13px] border border-indigo-100 text-center font-bold text-indigo-900 shadow-inner">
            ...
            <div class="bg-slate-800 p-5 rounded-xl shadow-md text-white border border-slate-700 relative overflow-hidden">
                <div class="absolute -right-4 -bottom-4 text-7xl opacity-10">💬</div>
                <b class="text-cyan-400 mb-3 block relative z-10 flex items-center gap-2"><span class="text-lg">🛠️</span> 3. ภาคปฏิบัติ: วิธีแปลผลกราฟและตัวเลขเพื่อนำเสนอลูกค้า (FA Action Plan)</b>
    ...
    "math-decum": {
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                <b class="text-purple-800 mb-2 flex items-center gap-2"><span class="text-lg">📉</span> 1. ทฤษฎีถอนเงินแบบไดนามิก (Guyton-Klinger Decision Rules)</b>
            ...
            <div class="bg-red-50 p-5 rounded-xl border border-red-200 shadow-sm flex flex-col">
                <b class="text-red-800 mb-2 flex items-center gap-2"><span class="text-lg">🌪️</span> 2. การประเมินความเสี่ยงด้านหาง (Tail Risk: Expected Shortfall / CVaR)</b>
                ...
                <div class="mt-2 mb-3 font-mono text-[13px] bg-white p-4 border border-red-200 rounded-lg text-center font-bold text-red-900 shadow-inner">
            ...
            <div class="bg-slate-800 p-5 rounded-xl shadow-md text-white border border-slate-700 relative overflow-hidden">
                <div class="absolute -right-4 -bottom-4 text-7xl opacity-10">💬</div>
                <b class="text-cyan-400 mb-3 block relative z-10 flex items-center gap-2"><span class="text-lg">🛠️</span> 3. ภาคปฏิบัติ: วิธีแปลผลและนำเสนอลูกค้า (FA Action Plan)</b>
    ...
    "math-knapsack": {
        ...
        <div class="space-y-5">
            ...
            <!-- กล่องที่ 1: ทฤษฎีวิชาการ -->
            <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                <b class="text-emerald-800 mb-2 flex items-center gap-2"><span class="text-lg">📚</span> 1. ทฤษฎี: Dynamic Programming & Multi-Objective Optimization</b>
                ...
                <div class="bg-emerald-50 p-4 rounded-lg font-mono text-[11px] border border-emerald-100 text-emerald-900 space-y-2 mb-2 overflow-x-auto shadow-inner">
                    <p class="font-bold border-b border-emerald-200 pb-1 mb-2 text-[12px]">State Transition Equation:</p>
                    <p class="text-center text-[13px] font-bold">DP[i][w] = max( DP[i-1][w], DP[i-1][w - P<sub>i</sub>] + U<sub>i</sub> )</p>
                    <ul class="list-none pl-2 text-[10px] text-emerald-800 mt-2 border-t border-emerald-200 pt-2 space-y-1">
                        <li><b>i:</b> ผลิตภัณฑ์ชิ้นที่ i, <b>w:</b> งบประมาณปัจจุบัน</li>
                        <li><b>P<sub>i</sub>:</b> เบี้ยประกัน (Cost), <b>U<sub>i</sub>:</b> อรรถประโยชน์ (Utility Score)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                <b class="text-emerald-800 mb-2 flex items-center gap-2"><span class="text-lg">🧮</span> 2. กลไกการประเมินเพื่อหาจุดที่ดีที่สุด (Optimization Mechanics)</b>
                    ...
                    <table class="w-full text-[11px] text-left border-collapse border border-gray-200">
                        <thead>
                            <tr class="bg-gray-100 border-b border-gray-300">
                                <th class="p-2 font-semibold text-gray-700">ผลิตภัณฑ์ (Items)</th>
                                <th class="border-l border-gray-200 p-2 font-semibold text-gray-700 text-right">เบี้ย (P)</th>
                                <th class="border-l border-gray-200 p-2 font-semibold text-gray-700 text-center">คะแนน (U)</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100">
                            <tr><td class="p-2">1. สุขภาพเหมาจ่าย (Major Med)</td><td class="border-l border-gray-100 p-2 text-right text-red-600">15,000</td><td class="border-l border-gray-100 p-2 text-center text-emerald-600 font-bold">80</td></tr>
                            <tr><td class="p-2">2. ประกันชีวิต (ทุนชีวิต)</td><td class="border-l border-gray-100 p-2 text-right text-red-600">4,000</td><td class="border-l border-gray-100 p-2 text-center text-emerald-600 font-bold">40</td></tr>
                            <tr><td class="p-2">3. ชดเชยรายวัน (HB)</td><td class="border-l border-gray-100 p-2 text-right text-red-600">3,000</td><td class="border-l border-gray-100 p-2 text-center text-emerald-600 font-bold">15</td></tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="bg-slate-800 p-5 rounded-xl shadow-md text-white border border-slate-700 relative overflow-hidden">
                <div class="absolute -right-4 -bottom-4 text-7xl opacity-10">💬</div>
                <b class="text-cyan-400 mb-3 block relative z-10 flex items-center gap-2"><span class="text-lg">🛠️</span> 3. ภาคปฏิบัติ: การใช้ AI ช่วยตอบข้อโต้แย้ง (FA Action Plan)</b>
    ...
    "term-invest": {
        ...
        <div class="mt-5 bg-slate-800 p-5 rounded-xl shadow-md text-white border border-slate-700 relative overflow-hidden">
            <div class="absolute -right-4 -bottom-4 text-7xl opacity-10">💬</div>
            <b class="text-cyan-400 mb-3 block relative z-10 flex items-center gap-2"><span class="text-lg">🛠️</span> ภาคปฏิบัติ: การนำไปใช้พูดคุยกับลูกค้า (FA Action Plan)</b>
    ...
    "term-behavior": {
        ...
        <div class="mt-5 bg-slate-800 p-5 rounded-xl shadow-md text-white border border-slate-700 relative overflow-hidden">
            <div class="absolute -right-4 -bottom-4 text-7xl opacity-10">💬</div>
            <b class="text-cyan-400 mb-3 block relative z-10 flex items-center gap-2"><span class="text-lg">🛠️</span> ภาคปฏิบัติ: จิตวิทยาการพูดคุยเพื่อเปลี่ยนพฤติกรรม (FA Action Plan)</b>
    ...
    "term-success-prob": {
        ...
        <div class="space-y-5 text-sm text-gray-700 leading-relaxed">
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-5 rounded-r-lg shadow-sm">
                <h4 class="font-bold text-blue-900 text-base mb-3">🎯 4 ปัจจัยหลักที่ AI ให้น้ำหนักสูงสุด พร้อมตัวอย่าง</h4>
            ...
            <h4 class="font-bold text-gray-800 text-base mt-6 mb-3 flex items-center gap-2"><span class="text-xl">🔍</span> กรณีศึกษา (Case Study): ความยืดหยุ่นที่ต่างกัน</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-slate-800 text-white p-5 rounded-xl mt-6 text-sm shadow-xl">
                <p class="font-bold text-yellow-400 mb-2 flex items-center gap-2"><span class="text-xl">💎</span> FA Takeaway (บทสรุปสำหรับที่ปรึกษา)</p>
