...
window.systemDictionary = {
    ...
    "manual-2": {
        ...
        title: "ส่วนที่ 2: คู่มือการบันทึกข้อมูล และสถาปัตยกรรมสมองกล (UI Input & AI Architecture)",
        content: `
            <div class="antialiased touch-manipulation">
                <p class="text-sm text-gray-600 mb-6 leading-relaxed">หัวใจสำคัญที่ทำให้ AI ประมวลผลได้อย่างแม่นยำ คือ <b>"คุณภาพของข้อมูลนำเข้า (Garbage In, Garbage Out)"</b> ส่วนนี้จะอธิบายขั้นตอนการเก็บข้อมูลผ่านหน้า UI แบบ Step-by-Step พร้อมเทคนิคการตั้งคำถาม (Fact-Finding) และสถาปัตยกรรมการทำงานของสมองกลหลังบ้านครับ</p>
                
                <!-- ========================================== -->
                <!-- 2.1 การกรอกข้อมูลลูกค้าหน้า UI (Step-by-Step) -->
                <!-- ========================================== -->
                <h4 class="font-bold text-gray-800 text-base mb-4 flex items-center gap-2 select-none"><span class="text-xl">📋</span> 2.1 คู่มือการกรอกข้อมูลและเทคนิค Fact-Finding (Step-by-Step)</h4>
                ...
                <div class="space-y-5 mb-8">
                    ...
                    <div class="bg-white p-5 rounded-xl border border-red-200 shadow-sm relative overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                            <div class="bg-red-50/50 p-3 rounded border border-red-100">
                                ...
                                <p class="text-[10px] text-gray-600"><b>ทำไม AI ต้องใช้?:</b> AI จะใช้อาชีพประเมิน "ความผันผวนของรายได้" (เช่น ฟรีแลนซ์ จะถูกบังคับให้เตรียมเงินสำรองฉุกเฉินมากกว่าพนักงานประจำ) และใช้สวัสดิการมาคำนวณหักลบ Gap ความคุ้มครองค่ารักษา</p>
                            </div>
                            <div class="bg-red-50/50 p-3 rounded border border-red-100">
                                <b class="text-[11px] text-red-700 block mb-1">▶ ประวัติสุขภาพ (Health Status)</b>
                                <p class="text-[10px] text-gray-600"><b>ทำไม AI ต้องใช้?:</b> หากเลือกว่า "มีโรคประจำตัว" AI จะปรับค่า "เงินเฟ้อทางการแพทย์ (Medical Inflation)" ให้สูงขึ้นอัตโนมัติ เพราะคนมีโรคย่อมมีค่าใช้จ่ายแฝงสูงกว่าคนปกติ</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-50 p-3 rounded-lg border border-slate-200 shadow-inner">
                            ...
                            <p class="text-[11px] text-gray-700 italic border-l-2 border-slate-400 pl-2">"สวัสดิการค่ารักษาที่บริษัทให้ ครอบคลุมถึงโรคร้ายแรงไหมครับ? และถ้าเราเกษียณหรือเปลี่ยนงาน สวัสดิการนี้จะยังตามดูแลเราอยู่ไหมครับ?"</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-xl border border-blue-200 shadow-sm relative overflow-hidden">
                        ...
                        <div class="bg-blue-50 p-3 rounded-lg border border-blue-200 shadow-inner">
                            ...
                            <p class="text-[11px] text-gray-700"><b>ห้ามชี้นำลูกค้าเด็ดขาด!</b> ให้อ่านคำถามแล้วให้ลูกค้าเลือกข้อที่ "ตรงกับตัวเองที่สุด ณ ปัจจุบัน" ไม่ใช่ข้อที่ "ดูดีที่สุด" เพราะถ้าข้อมูลหลอก AI จะจัดพอร์ตผิดความเสี่ยงทันที <i>(Pro tip: สังเกตสีหน้าลูกค้าตอนตอบเรื่อง "พอร์ตติดลบ 20%" จะช่วยให้คุณประเมินความกลัวในใจเขาได้)</i></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-xl border border-green-200 shadow-sm relative overflow-hidden">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-gray-50 p-3.5 rounded-lg border border-gray-200">
                                ...
                                <i class="text-[10px] text-gray-500 block mt-2">*ตัวอย่าง: กรอก "บ้านที่อยู่อาศัย" (สินทรัพย์ส่วนตัว) 5,000,000 บาท และ "เงินฝากธนาคาร" (สภาพคล่อง) 200,000 บาท</i>
                            </div>
                            ...
                            <div class="bg-gray-50 p-3.5 rounded-lg border border-gray-200">
                                ...
                                <i class="text-[10px] text-gray-500 block mt-2">*ตัวอย่าง: กรอก "ยอดหนี้บ้านคงเหลือ" (ระยะยาว) 3,500,000 บาท และ "หนี้บัตรเครดิต" (ระยะสั้น) 50,000 บาท</i>
                            </div>
                            ...
                            <div class="bg-gray-50 p-3.5 rounded-lg border border-gray-200">
                                ...
                                <i class="text-[10px] text-gray-500 block mt-2">*ตัวอย่าง: กรอก "เงินเดือน" (Active) 80,000 บาท/เดือน และ "โบนัส 2 เดือน" ให้นำ 160,000 หาร 12 = 13,333 บาท/เดือน</i>
                            </div>
                    ...
                    <div class="bg-white p-5 rounded-xl border border-purple-200 shadow-sm relative overflow-hidden">
                        ...
                        <div class="space-y-4">
                            <!-- 4.1 เป้าหมาย -->
                            <div class="bg-gray-50 p-3.5 rounded-lg border border-gray-200">
                                <b class="text-[12px] text-purple-700 block mb-1">🎯 4.1 เป้าหมายและการวางแผน (SMART Goals)</b>
                                <p class="text-[11px] text-gray-600 mb-2"><b>คืออะไร?:</b> พื้นที่ให้ AI ทราบว่าลูกค้าต้องการใช้เงินก้อนทำอะไรบ้าง เพื่อให้ AI ช่วยแบ่งเงินออมส่วนเกิน (Free Cash Flow) มารินใส่กระเป๋าให้ถึงเป้า</p>
                                <p class="text-[11px] text-gray-600 mb-1"><b>ต้องกรอกอะไรบ้าง?:</b></p>
                                <ul class="list-disc list-inside text-[11px] text-gray-700 space-y-1 ml-1">
                                    <li><b>ชื่อเป้าหมาย:</b> เช่น ดาวน์รถใหม่, ทุนการศึกษาป.โท, เที่ยวยุโรป</li>
                                    <li><b>จำนวนเงิน (บาท):</b> มูลค่าเป้าหมาย เช่น 1,000,000</li>
                                    <li><b>ระยะเวลา (ปี):</b> ระยะเวลาที่มีให้ออม เช่น 5 (ปี)</li>
                                    <li><b>ความสำคัญ (Priority):</b> ใส่ 1 (สำคัญสุด) ไปจนถึง 2, 3, 4 (AI จะเทเงินให้เป้าหมายเบอร์ 1 จนเต็มก่อนเสมอ)</li>
                                </ul>
                            </div>

                            <!-- 4.2 กรมธรรม์เดิม -->
                            <div class="bg-gray-50 p-3.5 rounded-lg border border-gray-200">
                                <b class="text-[12px] text-teal-700 block mb-1">🛡️ 4.2 กรมธรรม์ประกันชีวิตปัจจุบัน (Protection)</b>
                                <p class="text-[11px] text-gray-600 mb-2"><b>คืออะไร?:</b> การวิเคราะห์ "ร่มชูชีพ" ที่ลูกค้ามีอยู่แล้ว เพื่อทำ Gap Analysis หา "ส่วนขาด (Shortfall)"</p>
                                <p class="text-[11px] text-gray-600 mb-1"><b>ต้องกรอกอะไรบ้าง?:</b></p>
                                <ul class="list-disc list-inside text-[11px] text-gray-700 space-y-1 ml-1">
                                    <li>กด <b>"+ เพิ่มกรมธรรม์ (สัญญาหลัก)"</b> เลือกว่าเป็น ตลอดชีพ, บำนาญ, ยูนิตลิงค์ กรอก <span class="text-blue-600">ทุนชีวิต</span>, <span class="text-orange-600">เบี้ยรายปี</span>, และ <span class="text-green-600">มูลค่าเวนคืน (CV ปัจจุบัน)</span></li>
                                    <li>ถ้าเล่มนั้นมีออปชั่นเสริม ให้กดปุ่ม <b>"+ เพิ่มสัญญาเพิ่มเติม (Rider)"</b> ไว้ใต้เล่มนั้น เลือกว่าเป็น สุขภาพ, โรคร้ายแรง(CI), หรือชดเชยรายวัน กรอก<span class="text-blue-600">วงเงินรักษา</span> และ <span class="text-orange-600">เบี้ยทิ้ง</span></li>
                                    <li class="font-bold text-red-600 mt-1">อย่าลืมกดปุ่ม "🔄 ซิงค์เข้าสู่งบการเงิน" เพื่อให้ AI ดึงค่าเบี้ยไปเป็น 'รายจ่าย' และมูลค่าเวนคืนไปเป็น 'สินทรัพย์' อัตโนมัติ!</li>
                                </ul>
                            </div>

                            <!-- 4.3 การลงทุนเดิม -->
                            <div class="bg-gray-50 p-3.5 rounded-lg border border-gray-200">
                                <b class="text-[12px] text-indigo-700 block mb-1">📈 4.3 การลงทุนตราสารการเงินปัจจุบัน</b>
                                <p class="text-[11px] text-gray-600 mb-2"><b>คืออะไร?:</b> ระบุไส้ในของสินทรัพย์ลงทุน เพื่อคำนวณผลตอบแทนเฉลี่ย (Weighted ROI) และความผันผวน (SD) ของพอร์ตปัจจุบัน</p>
                                <p class="text-[11px] text-gray-600 mb-1"><b>ต้องกรอกอะไรบ้าง?:</b> เลือกประเภท (เช่น หุ้นไทย, ต่างประเทศ), กรอกมูลค่า, ผลตอบแทนที่คาดหวัง(%), และวัตถุประสงค์ (เช่น เพื่อเกษียณ, เป็นสำรองฉุกเฉิน)</p>
                                <i class="text-[10px] text-gray-500">*ตัวอย่าง: เลือก "หุ้นต่างประเทศ" ใส่ 500,000 บาท คาดหวัง 8% เป้าหมายคือ ทุนเกษียณอายุ</i>
                            </div>

                            <!-- 4.4 วางแผนภาษี -->
                            <div class="bg-gray-50 p-3.5 rounded-lg border border-gray-200">
                                <b class="text-[12px] text-orange-700 block mb-1">⚖️ 4.4 การวางแผนภาษีปัจจุบัน (รายการลดหย่อน)</b>
                                <p class="text-[11px] text-gray-600 mb-2"><b>คืออะไร?:</b> ข้อมูลสำหรับประเมิน <b>Tax Alpha</b> เพื่อหาว่าลูกค้าใช้สิทธิลดหย่อนคุ้มหรือยัง และควรย้ายเงินไปลงกองทุนประหยัดภาษีเพิ่มหรือไม่</p>
                                <p class="text-[11px] text-gray-600 mb-1"><b>ต้องกรอกอะไรบ้าง?:</b> ง่ายมาก! แค่กดปุ่ม <span class="bg-orange-100 text-orange-800 px-1 rounded font-bold">🔄 ดึงข้อมูลจากระบบ</span> AI จะวิ่งไปกวาด "เบี้ยประกันชีวิต, ดอกเบี้ยบ้าน, เงินสมทบประกันสังคม, RMF/SSF" จากทุกตารางที่คุณเพิ่งกรอกมาสรุปเป็นยอดลดหย่อนให้อัตโนมัติ (สามารถบวกเพิ่มเองได้ เช่น ลดหย่อนบุตร หรือบริจาค)</p>
                            </div>
                        </div>

                        <div class="bg-purple-50 p-3 rounded-lg border border-purple-200 shadow-inner mt-4">
                    ...
                    <div class="bg-white p-5 rounded-xl border border-indigo-200 shadow-sm relative overflow-hidden">
                        ...
                        <p class="text-[11px] text-gray-600 mb-2"><b>คืออะไร?:</b> ปลายทางสูงสุดของการวางแผนการเงิน เพื่อส่งให้ Monte Carlo Simulation รันโลกคู่ขนาน 2,000 รอบหาโอกาสรอด</p>
                        ...
                        <div class="bg-gray-50 p-3 rounded border border-gray-200 mb-3">
                            ...
                            <p class="text-[10px] text-gray-500">สามารถคลิกเปิดแถบเมนูนี้ เพื่อปรับ "เงินเฟ้อทั่วไป", "เงินเฟ้อแพทย์", และ "ผลตอบแทนคาดหวังรวม" ด้วยตนเองได้ (หากไม่ปรับ AI จะอิงตาม Risk Score อัตโนมัติ)</p>
                        </div>

                        <div class="bg-indigo-50 p-3 rounded-lg border border-indigo-200 shadow-inner mt-4 text-center">
                            <b class="text-indigo-800 text-sm block mb-1">🚀 ขั้นตอนสุดท้าย: การประมวลผล</b>
                            <p class="text-xs text-gray-700">เมื่อกรอกครบ 5 ขั้นตอน ให้กดปุ่ม <b>"⚙️ ประมวลผล"</b> สีแดงด้านขวาบน<br> หน้าจอจะขึ้น Loading AI และเข้าสู่หน้ารายงานที่สวยงามทันที!</p>
                        </div>
                    </div>
                ...
                <!-- ========================================== -->
                <!-- 2.2 สถาปัตยกรรมสมองกลที่ใช้ประมวลผล (AI Pipeline) -->
                <!-- ========================================== -->
                <h4 class="font-bold text-gray-800 text-base mb-4 flex items-center gap-2 select-none border-t border-gray-300 pt-8"><span class="text-xl">⚙️</span> 2.2 สถาปัตยกรรมสมองกลที่ใช้ประมวลผล (AI Pipeline)</h4>
                <p class="text-sm text-gray-600 mb-4">เมื่อข้อมูลดิบจากหน้า UI ถูกส่งเข้าระบบ จะวิ่งผ่านกระบวนการ 5 ขั้นตอน (5-Stage Engine) ภายในเวลาไม่กี่วินาที ดังนี้:</p>
    ...
    "term-success-prob": {
        ...
        <div class="space-y-5 text-sm text-gray-700 leading-relaxed antialiased touch-manipulation pb-safe">
            ...
            <!-- 🌟 ส่วนที่เพิ่มใหม่: อธิบายที่มาของ 99.50% และการคำนึงถึงทรัพยากร -->
            <h4 class="font-bold text-gray-800 text-base mt-8 mb-3 flex items-center gap-2 select-none"><span class="text-xl">🚀</span> ทำไมหลังปรับแผน (Proposed) คะแนนถึงพุ่งขึ้น (เช่น 99.50%?)</h4>
            <div class="bg-indigo-50 p-5 rounded-xl border border-indigo-200 shadow-sm mb-6">
                <p class="text-gray-800 text-sm mb-4 leading-relaxed">
                    ตัวเลข <b>99.50%</b> (ซึ่งเป็นเพดานสูงสุดที่ระบบตั้งไว้เผื่อวิกฤต Black Swan) ไม่ได้มาจากการนั่งเทียนคาดเดา หรือเสกเงินต้นในอุดมคติ แต่มาจากการทำงานของ <b>Monte Carlo Simulation</b> ที่จำลองอนาคตล่วงหน้า 2,000 รูปแบบ โดยยืนอยู่บน <b>"พื้นฐานทรัพยากรที่มีอยู่จริงและทำได้จริง"</b> ของลูกค้าเท่านั้น แบ่งเป็น 2 ส่วนคือ:
                </p>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div class="bg-white p-4 rounded-lg border border-indigo-100 shadow-sm">
                        <b class="text-indigo-800 block mb-2 flex items-center gap-1"><span class="text-lg">📦</span> 1. ทรัพยากรปัจจุบัน (Baseline)</b>
                        <span class="text-xs text-gray-600 leading-relaxed block">AI จะใช้ตัวเลข "ณ วันนี้" เป็นจุดสตาร์ท (Year 0) เสมอ ได้แก่ เงินลงทุนตั้งต้นที่มี, ภาระหนี้สินปัจจุบันที่ต้องผ่อน, และสภาพคล่องที่มีสำรองไว้ ระบบไม่สามารถเสกเงินก้อนใหม่ให้ลูกค้าได้</span>
                    </div>
                    <div class="bg-white p-4 rounded-lg border border-indigo-100 shadow-sm">
                        <b class="text-indigo-800 block mb-2 flex items-center gap-1"><span class="text-lg">🔮</span> 2. ทรัพยากรอนาคต (Projections)</b>
                        <span class="text-xs text-gray-600 leading-relaxed block">คาดการณ์จากสิ่งที่จะเกิดขึ้นจริง ได้แก่ เงินออมส่วนเกินรายเดือน (Free Cash Flow) ที่สามารถนำมา DCA เพิ่มได้, สวัสดิการบำนาญที่จะได้รับ, และผลตอบแทนที่คาดหวังจากการปรับพอร์ตใหม่ (Optimized ROI)</span>
                    </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-lg border border-indigo-100 shadow-sm">
                    ...
                    <p class="text-xs text-gray-700 leading-relaxed">
                        การที่ระบบแสดงโอกาสสำเร็จสูงขึ้น ในแผน Proposed สามารถแปลให้ลูกค้าฟังได้ง่ายๆ ว่า:<br>
                        <i>"AI ได้เช็คปริมาณน้ำมันในถัง (เงินตั้งต้นปัจจุบัน) และคำนวณแล้วว่า ถ้าพี่ลูกค้าเปลี่ยนเส้นทางมาขึ้นทางด่วน (ปรับพอร์ตให้ ROI ชนะเงินเฟ้อ) และเหยียบคันเร่งเพิ่มขึ้นอีกนิดด้วยเงินออมที่พี่ทำได้จริงทุกเดือน (DCA) รถคันนี้จะวิ่งถึงเป้าหมายเกษียณได้แน่นอน แม้ระหว่างทางจะเจอพายุหรือรถติด (ความผันผวนของตลาด) ก็ตามครับ"</i>
                    </p>
                </div>
            </div>

            <!-- 🌟 ส่วนที่เพิ่มใหม่: อธิบายที่มาของ 0.00% -->
            <h4 class="font-bold text-gray-800 text-base mt-8 mb-3 flex items-center gap-2 select-none"><span class="text-xl">☠️</span> ทำไมบางเคสถึงคำนวณได้ 0.00% เป๊ะ? (Mathematical Reality Check)</h4>
            <div class="bg-red-50 p-5 rounded-xl border border-red-200 shadow-sm mb-6">
                <p class="text-gray-800 text-sm mb-4 leading-relaxed">
                    การที่ AI ประเมินได้ <b>0.00%</b> ไม่ใช่บั๊กของระบบ แต่เป็นการสะท้อนความจริงทางคณิตศาสตร์ว่า <b>"เมื่อรันล่วงหน้าไป 2,000 รูปแบบ ไม่มีรูปแบบไหนเลยที่รอด เงินในพอร์ตถูกถอนจนเกลี้ยงก่อนตาย 100%"</b> ซึ่งมักเกิดจาก:
                </p>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div class="bg-white p-4 rounded-lg border border-red-100 shadow-sm hover:shadow-md transition">
                        ...
                        <span class="text-[11px] text-gray-600 leading-relaxed block">รายจ่ายเกินรายรับ ระบบต้องจำลอง "แคะกระปุก" ถอนเงินก้อนเก็บมากินใช้ทุกเดือนจนหมด</span>
                    </div>
                    <div class="bg-white p-4 rounded-lg border border-red-100 shadow-sm hover:shadow-md transition">
                        <b class="text-red-800 block mb-2 flex items-center gap-1 text-xs"><span class="text-base">🏔️</span> 2. เป้าหมายเกินจริง</b>
                        <span class="text-[11px] text-gray-600 leading-relaxed block">มีเงินต้นน้อย แต่อยากใช้หลังเกษียณเยอะ พอเจอเงินเฟ้อทบต้น วันเกษียณเงินหมดภายใน 1-3 ปี</span>
                    </div>
                    <div class="bg-white p-4 rounded-lg border border-red-100 shadow-sm hover:shadow-md transition">
                        <b class="text-red-800 block mb-2 flex items-center gap-1 text-xs"><span class="text-base">⚓</span> 3. โดน Penalty ดึงรั้ง</b>
                        <span class="text-[11px] text-gray-600 leading-relaxed block">หนี้สูงและสภาพคล่องต่ำ ระบบ Parameter Injection จะทำโทษโดยหักลดยอดออมจำลองลง 20% อัตโนมัติ</span>
                    </div>
                </div>
                <div class="bg-white p-4 rounded-lg border border-red-100 shadow-sm">
                    ...
                    <p class="text-xs text-gray-700 leading-relaxed">
                        เลข 0.00% คือโอกาสทองในการขาย (Pain Point) ให้บอกลูกค้าว่า <i>"ถ้าใช้ชีวิตแบบเดิม ล้มละลายตอนแก่แน่นอนครับ"</i> จากนั้นให้ใช้ <b>แถบสไลเดอร์ What-If</b> ลองลดยอดใช้จ่ายหลังเกษียณ หรือเลื่อนอายุเกษียณให้ลูกค้าดู ตัวเลขจะเด้งกลับขึ้นมาทันที!
                    </p>
                </div>
            </div>
    ...
    "term-xai": {
        ...
        title: "ส่วนที่ 17: ระบบ Explainable AI (XAI) ถอดรหัสความคิดสมองกล",
        content: `
        <div class="space-y-5 text-sm text-gray-700 leading-relaxed antialiased touch-manipulation pb-safe">
            <p class="bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
